...
var musics1 = [
	...
	{ aud: new Audio('Let Me Down Slowly x Main Dhoondne Ko.mp3'), name: 'Let Me Down Slowly x Main Dhoondne Ko' },
	{ aud: new Audio('Let Me Down Slowly.mp3'), name: 'Let Me Down Slowly' },
	{ aud: new Audio('Make You Mine.mp3'), name: 'Make You Mine' }
];

var musics = [
	{ aud: new Audio('audios/Make You Mine.mp3'), name: 'Make You Mine' },
	{ aud: new Audio('audios/Let Me Down Slowly.mp3'), name: 'Let Me Down Slowly' },
	{ aud: new Audio('audios/Heat_Waves.mp3'), name: 'Heat Waves [Glass Animals]' }
];
